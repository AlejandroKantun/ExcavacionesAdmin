...
enum QuerySentences{
    ...
    createMaterialsTB="CREATE TABLE IF NOT EXISTS materiales(materialID INTEGER PRIMARY KEY AUTOINCREMENT, nombreMaterial varchar(100) NOT NULL, fechaCreacion datetime not null, fechaUltimaModificacion datetime null, fechaEliminacion datetime null, fechaSincronizacion datetime null, activoMaterial bit NOT NULL DEFAULT 1, estadoMaterial bit NOT NULL DEFAULT 1, importe double null, EnviadoABaseDeDatosCentral bit NOT NULL DEFAULT 0, creadoPor int null, foreign key (creadoPor) references usuarios(usuarioID))",
    ...
    createVehiclesTB="CREATE TABLE vehiculos (vehiculoID INTEGER PRIMARY KEY AUTOINCREMENT, tipoUnidad varchar(100) NOT NULL, placa varchar(20) NOT NULL, capacidad varchar(50) NULL, numeroEconomico varchar(10) NULL, codigoQR varchar(100) null, fechaCreacion datetime not null, fechaUltimaModificacion datetime null, fechaEliminacion datetime null, fechaSincronizacion datetime null, activoVehiculo bit NOT NULL DEFAULT 1, estadoVehiculo bit NOT NULL DEFAULT 1, empresaID int null, creadoPor int null, numeroTolva varchar(50) null, EnviadoABaseDeDatosCentral bit NOT NULL DEFAULT 0, foreign key (empresaID) references empresas(empresaID), foreign key (creadoPor) references usuarios(usuarioID))",
    ...
    createTicketsTB="CREATE TABLE vales (valeID INTEGER PRIMARY KEY AUTOINCREMENT, bancoID int not null, serie varchar(5) not NULL, folio varchar(10) not NULL, folioDigital varchar(50) null, folioFisico varchar (20) null, fechaVale datetime not null, tipoUnidad varchar(100) NOT NULL, placa varchar(100) NOT NULL, numeroEconomico varchar(10) NULL, numeroValeTriturador varchar(50) NULL, observaciones text null, fechaEntradaVehiculo datetime null, fechaSalidaVehiculo datetime null, firma blob null, fechaCreacion datetime not null, fechaUltimaModificacion datetime null, fechaEliminacion datetime null, fechaSincronizacion datetime null, activoVale bit NOT NULL DEFAULT 1, estadoVale bit NOT NULL DEFAULT 1, clienteID int not null, destinoID int not null, vehiculoID int not null, empresaID int not null, choferID int null, choferNombre varchar(100) null, clienteNombre varchar(100) null, destinoNombre varchar(100) null, vehiculoNombre varchar(100) null, creadoPor int null, EnviadoABaseDeDatosCentral bit NOT NULL DEFAULT 0, Importe double null, numeroTolva varchar(50) null, formadepago varchar(20) null, empresaNombre varchar (100) null, observacionesEliminar text null, foreign key (clienteID) references clientes(clienteID), foreign key (destinoID) references destinos(destinoID), foreign key (vehiculoID) references vehiculos(vehiculoID), foreign key (empresaID) references empresas(empresaID), foreign key (choferID) references choferes(choferID), foreign key (creadoPor) references usuarios(usuarioID))",
    ...
    createTicketsMaterialsTB="CREATE TABLE valesmateriales (valeMaterialID INTEGER PRIMARY KEY AUTOINCREMENT, materialNombre varchar(100) null, cantidadm3 double not NULL, valeID int not null, materialID int not null, EnviadoABaseDeDatosCentral bit NOT NULL DEFAULT 0, costom3 double null, foreign key (valeID) references vales(valeID), foreign key (materialID) references materiales(materialID))",
